...
public class BossHealth : MonoBehaviour
{
    ...
    [Header("Créditos")]
    public bool showCreditsOnDeath = false;
    ...
    void Awake()
    {
        ...
        // Esconde o boss até confirmar que não foi derrotado
    ...
    IEnumerator Start()
    {
        // Espera 1 frame para o PlayerSave ter aplicado os dados
        yield return null;
    ...
    void Die()
    {
        ...
        // Mostrar créditos se ativado
        if (showCreditsOnDeath)
        {
